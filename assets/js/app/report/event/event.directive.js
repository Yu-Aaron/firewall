...
//            require: '^dtable',
//            replace: true,
//            templateUrl: '/templates/report/event/incident-table.html',
//            link: link
//        };
//
...
//                    data.map(function (d) {
//                        d.action = d.action === 'ERROR' ? '错误' : d.action === 'WARN' ? '警告' : d.action === 'ALERT' ? '警告' : d.action === 'DENY' ? '阻断' : '';
//                    });
//                    setTimeout(function () {
...
//            require: '^dtable',
//            replace: true,
//            templateUrl: '/templates/report/event/event-table.html',
//            link: link
//        };
//
